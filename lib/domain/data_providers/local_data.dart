...
abstract class LocalData {
  ...
  static final List<LocalClub> clubs = [
    ...
    LocalClub(
      name: 'Sport Club',
      imageUrl: 'assets/images/im_club_4.png',
      description:
          'Regular training sessions, practice matches, and tournaments keep you engaged and motivated, helping you improve your skills, endurance, and overall fitness. Moreover, sports clubs offer valuable opportunities for personal growth and character development.',
      gallery: [
        'assets/images/sport_gallery_1.jpg',
        'assets/images/sport_gallery_2.jpg'
      ],
    ),
  ...
  static final List<SpaceLocal> spaces = [
    SpaceLocal(
        imageUrl: 'assets/images/image 3-2.png',
        name: 'ACM Community',
        postLength: '163 posts'),
    SpaceLocal(
        imageUrl: 'assets/images/image 3-3.png',
        name: 'Eat&Chat',
        postLength: '255 posts'),
    SpaceLocal(
        imageUrl: 'assets/images/image 3-4.png',
        name: 'Uni Activities',
        postLength: '766 posts'),
    SpaceLocal(
        imageUrl: 'assets/images/image 3-5.png',
        name: 'SDU Football League',
        postLength: '175 posts'),
    SpaceLocal(
        imageUrl: 'assets/images/image 3-6.png',
        name: 'Lost and Found SDU',
        postLength: '255 posts'),
    SpaceLocal(
        imageUrl: 'assets/images/image 3-7.png',
        name: 'Startup Garage',
        postLength: '1163 posts'),
    SpaceLocal(
        imageUrl: 'assets/images/image 3-8.png',
        name: 'Designers SDU',
        postLength: '163 posts'),
    SpaceLocal(
        imageUrl: 'assets/images/image 3-4.png',
