        ...
        : SingleChildScrollView(
          child: Column(
            children: [
              Stack(
                children: [
                  Image.asset(widget.event.imageUrl),
                  Positioned(
                    top: 20,
                    left: 16,
                    child: SafeArea(
              ...
              Padding(
                ...
                child: Column(
                  children: [
                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            ...
                            Text(widget.event.createdDate, style: const TextStyle(
                                fontSize: 12
                            ),),
                          ],
                        ),
                    ...
                    const SizedBox(height: 24,),
                    Text(
                      widget.event.description ?? 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam viverra nulla sapien, '
