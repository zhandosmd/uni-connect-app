    ...
    return Column(
      ...
      children: [
                ...
                child: GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: isPaid == 1 ? AppColors.black : AppColors.mainColor,
                      borderRadius: const BorderRadius.all(Radius.circular(12))
                    ),
                    child: const Center(child: Text('Free Tariff'),),
                  ),
                ),
              ),
              Expanded(
                child: GestureDetector(
                  ...
                  child: Container(
                    height: 41,
                    decoration: BoxDecoration(
                      color: isPaid == 0 ? AppColors.black : AppColors.mainColor,
                      borderRadius: const BorderRadius.all(Radius.circular(12))
                    ),
                    child: const Center(child: Text('Paid Tariff'),),
                  ),
                ),
              ),
            ],
        ...
        if(isPaid == 1)
          Column(
            ...
            children: [
              ...
              const SizedBox(height: 15),
              const Text('Price (tenge)', style: TextStyle(
                  fontSize: 14, fontWeight: FontWeight.w700
              ),),
              const SizedBox(height: 15),
              Container(
        ...
        Row(
          ...
          children: [
            const Text('Limited tickets count', style: TextStyle(
              fontSize: 14, fontWeight: FontWeight.w700
            ),),
            CupertinoSwitch(
        ...
        if(isLimitedTickets)
          Column(
            ...
            children: [
              ...
              const Text('Ticket count', style: TextStyle(
                  fontSize: 14, fontWeight: FontWeight.w700
              ),),
              const SizedBox(height: 15),
              Container(
